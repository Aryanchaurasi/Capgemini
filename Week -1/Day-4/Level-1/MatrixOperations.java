...
public class MatrixOperations 
{
    	...
    	public static int determinant3x3(int[][] matrix) 
	{
		...
		{
            		return matrix[0][0] * determinant2x2(new int[][]{{matrix[1][1], matrix[1][2]}, {matrix[2][1], matrix[2][2]}}) - matrix[0][1] * determinant2x2(new int[][]{{matrix[1][0], matrix[1][2]}, {matrix[2][0], matrix[2][2]}}) + matrix[0][2] * determinant2x2(new int[][]{{matrix[1][0], matrix[1][1]}, {matrix[2][0], matrix[2][1]}});
        	}


        	public static double[][] inverse2x2(int[][] matrix) {
            int determinant = determinant2x2(matrix);
            return new double[][]{{matrix[1][1] / (double) determinant, -matrix[0][1] / (double) determinant}, {-matrix[1][0] / (double) determinant, matrix[0][0] / (double) determinant}
            };
        }
